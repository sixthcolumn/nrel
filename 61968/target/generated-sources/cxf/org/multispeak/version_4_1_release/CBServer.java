 ...
 * 2016-06-12T10:32:12.003-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "CB_Server", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/cb_server_special.wsdl",
...
public class CBServer extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/cb_server_special.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CBServer.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/cb_server_special.wsdl");
        }
        WSDL_LOCATION = url;
    }
