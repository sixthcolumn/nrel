...
@XmlType(name = "status", propOrder = {
    "clockBackwardOrOverflowOrInvalid"
})
public class Status {
    ...
    /**
     * Gets the value of the clockBackwardOrOverflowOrInvalid property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the clockBackwardOrOverflowOrInvalid property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClockBackwardOrOverflowOrInvalid().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<Boolean>> getClockBackwardOrOverflowOrInvalid() {
        if (clockBackwardOrOverflowOrInvalid == null) {
            clockBackwardOrOverflowOrInvalid = new ArrayList<JAXBElement<Boolean>>();
        }
        return this.clockBackwardOrOverflowOrInvalid;
    }
