...
package ch.iec.tc57._2010.schema.message;
 ...
 * generated in the ch.iec.tc57._2010.schema.message package. 
...
public class ObjectFactory {
    ...
    private final static QName _Message_QNAME = new QName("http://www.iec.ch/TC57/2010/schema/message", "Message");
    private final static QName _ResponseMessage_QNAME = new QName("http://www.iec.ch/TC57/2010/schema/message", "ResponseMessage");
    private final static QName _FaultMessage_QNAME = new QName("http://www.iec.ch/TC57/2010/schema/message", "FaultMessage");
    private final static QName _RequestMessage_QNAME = new QName("http://www.iec.ch/TC57/2010/schema/message", "RequestMessage");
    private final static QName _EventMessage_QNAME = new QName("http://www.iec.ch/TC57/2010/schema/message", "EventMessage");
    private final static QName _AdverbTypes_QNAME = new QName("http://www.iec.ch/TC57/2010/schema/message", "adverbTypes");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ch.iec.tc57._2010.schema.message
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.iec.ch/TC57/2010/schema/message", name = "Message")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.iec.ch/TC57/2010/schema/message", name = "ResponseMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.iec.ch/TC57/2010/schema/message", name = "FaultMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.iec.ch/TC57/2010/schema/message", name = "RequestMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.iec.ch/TC57/2010/schema/message", name = "EventMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.iec.ch/TC57/2010/schema/message", name = "adverbTypes")
    public JAXBElement<String> createAdverbTypes(String value) {
        return new JAXBElement<String>(_AdverbTypes_QNAME, String.class, null, value);
    }
