 ...
 * 2016-06-12T10:32:12.519-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "RequestWorkRequest", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/61968-6/RequestWorkRequest.wsdl",
...
public class RequestWorkRequest extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/61968-6/RequestWorkRequest.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RequestWorkRequest.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/61968-6/RequestWorkRequest.wsdl");
        }
        WSDL_LOCATION = url;
    }
