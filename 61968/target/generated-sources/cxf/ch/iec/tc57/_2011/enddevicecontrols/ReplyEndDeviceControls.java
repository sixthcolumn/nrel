 ...
 * 2016-06-12T10:32:06.496-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyEndDeviceControls", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/ReplyEndDeviceControls.wsdl",
...
public class ReplyEndDeviceControls extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/ReplyEndDeviceControls.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyEndDeviceControls.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/ReplyEndDeviceControls.wsdl");
        }
        WSDL_LOCATION = url;
    }
