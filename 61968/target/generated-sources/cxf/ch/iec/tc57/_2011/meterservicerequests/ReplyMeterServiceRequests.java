 ...
 * 2016-06-12T10:32:05.651-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyMeterServiceRequests", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/ReplyMeterServiceRequests.wsdl",
...
public class ReplyMeterServiceRequests extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/ReplyMeterServiceRequests.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyMeterServiceRequests.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/ReplyMeterServiceRequests.wsdl");
        }
        WSDL_LOCATION = url;
    }
