 ...
 * 2016-06-12T10:32:04.745-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyMeterReadings", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/ReplyMeterReadings.wsdl",
...
public class ReplyMeterReadings extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/ReplyMeterReadings.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyMeterReadings.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/ReplyMeterReadings.wsdl");
        }
        WSDL_LOCATION = url;
    }
