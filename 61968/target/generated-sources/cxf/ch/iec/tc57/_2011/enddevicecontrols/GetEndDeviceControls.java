 ...
 * 2016-06-12T10:31:58.337-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "GetEndDeviceControls", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/GetEndDeviceControls.wsdl",
...
public class GetEndDeviceControls extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/GetEndDeviceControls.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GetEndDeviceControls.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/GetEndDeviceControls.wsdl");
        }
        WSDL_LOCATION = url;
    }
