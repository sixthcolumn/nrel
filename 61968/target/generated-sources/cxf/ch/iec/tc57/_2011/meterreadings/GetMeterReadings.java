 ...
 * 2016-06-12T10:32:04.549-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "GetMeterReadings", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/GetMeterReadings.wsdl",
...
public class GetMeterReadings extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/GetMeterReadings.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GetMeterReadings.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/GetMeterReadings.wsdl");
        }
        WSDL_LOCATION = url;
    }
