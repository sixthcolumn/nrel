 ...
 * 2016-06-12T10:32:06.901-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyEndDeviceEvents", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/ReplyEndDeviceEvents.wsdl",
...
public class ReplyEndDeviceEvents extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/ReplyEndDeviceEvents.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyEndDeviceEvents.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/ReplyEndDeviceEvents.wsdl");
        }
        WSDL_LOCATION = url;
    }
