 ...
 * 2016-06-12T10:32:05.114-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "RequestMeterReadings", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/RequestMeterReadings.wsdl",
...
public class RequestMeterReadings extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/RequestMeterReadings.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RequestMeterReadings.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/RequestMeterReadings.wsdl");
        }
        WSDL_LOCATION = url;
    }
