 ...
 * 2016-06-12T10:32:12.309-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "Request", 
                  wsdlLocation = "file:/usr/local/git/nrel/61968/wsdl/Request.wsdl",
...
public class Request extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/usr/local/git/nrel/61968/wsdl/Request.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Request.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/usr/local/git/nrel/61968/wsdl/Request.wsdl");
        }
        WSDL_LOCATION = url;
    }
