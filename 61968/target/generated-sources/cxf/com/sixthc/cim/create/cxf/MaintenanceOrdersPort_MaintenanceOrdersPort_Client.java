...
public final class MaintenanceOrdersPort_MaintenanceOrdersPort_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        com.sixthc.cim.create2.HeaderType _createMaintenanceOrders_headerVal = null;
        javax.xml.ws.Holder<com.sixthc.cim.create2.HeaderType> _createMaintenanceOrders_header = new javax.xml.ws.Holder<com.sixthc.cim.create2.HeaderType>(_createMaintenanceOrders_headerVal);
        com.sixthc.cim.create2.RequestType _createMaintenanceOrders_request = null;
        com.sixthc.cim.create.cxf.MaintenanceOrdersPayloadType _createMaintenanceOrders_payloadVal = null;
        javax.xml.ws.Holder<com.sixthc.cim.create.cxf.MaintenanceOrdersPayloadType> _createMaintenanceOrders_payload = new javax.xml.ws.Holder<com.sixthc.cim.create.cxf.MaintenanceOrdersPayloadType>(_createMaintenanceOrders_payloadVal);
        javax.xml.ws.Holder<com.sixthc.cim.create2.ReplyType> _createMaintenanceOrders_reply = new javax.xml.ws.Holder<com.sixthc.cim.create2.ReplyType>();
        try {
