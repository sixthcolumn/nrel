...
import com.sixthc.cim.get2.OperationSet;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://iec.ch/TC57/2015/MaintenanceOrders#}MaintenanceOrders" minOccurs="0"/>
...
@XmlType(name = "MaintenanceOrdersPayloadType", namespace = "http://iec.ch/TC57/2015/GetMaintenanceOrdersMessage", propOrder = {
    "maintenanceOrders",
    "operationSet",
    "compressed",
    "format"
...
public class MaintenanceOrdersPayloadType {
    ...
    protected MaintenanceOrders2 maintenanceOrders;
     ...
     * @return
     *     possible object is
     *     {@link MaintenanceOrders2 }
     *     
     */
    public MaintenanceOrders2 getMaintenanceOrders() {
     ...
     *     
     */
    public void setMaintenanceOrders(MaintenanceOrders2 value) {
